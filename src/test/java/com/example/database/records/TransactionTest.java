...
public class TransactionTest {
    ...
    public void codeTooSmallException() {
        var ex = assertThrows(IllegalArgumentException.class, () -> {
            new Transaction(10, "", "NASDAQ", 30.0, 200.8, true);
        });
    ...
    public void exchangeTooBigException() {
        var ex = assertThrows(IllegalArgumentException.class, () -> {
            new Transaction(10, "AAPL", BIG_STR, 30.0, 200.8, true);
        });
    ...
    public void exchangeTooSmallException() {
        var ex = assertThrows(IllegalArgumentException.class, () -> {
            new Transaction(10, "AAPL", "", 30.0, 200.8, true);
        });
    ...
    public void priceTooBigException() {
        var ex = assertThrows(IllegalArgumentException.class, () -> {
            new Transaction(10, "AAPL", "NASDAQ", 30.0, Double.MAX_VALUE, true);
        });
